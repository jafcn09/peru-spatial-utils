...
const I18N = {
  es: {
    ...
    'map.caption': 'Consulta o toca un departamento para resaltarlo.', 'map.dept': 'Departamento', 'map.select': 'Elegir departamento',
...
+ ' Ligera, sin dependencias y disponible para TypeScript, Python, Dart, Go, Java, Rust y C.',
  ...
  en: {
    ...
    'map.caption': 'Look up or tap a department to highlight it.', 'map.dept': 'Department', 'map.select': 'Choose department',
